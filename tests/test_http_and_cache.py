...
class TestHTTPToolkitUnits:
    ...
    def test_request_config_defaults(self):
        from core.http_toolkit import RequestConfig
    ...
    def test_response_data_is_success(self):
        from core.http_toolkit import ResponseData
    ...
    def test_header_mimicry_rotation(self):
        from core.http_toolkit import HeaderMimicry
    ...
    def test_semantic_processor_roundtrip(self):
        from core.http_toolkit import SemanticProcessor
    ...
    def test_ai_analysis_security_headers(self):
        from core.http_toolkit import AIIntegration, RequestConfig, ResponseData
    ...
    def test_auto_repair_strategies(self):
        from core.http_toolkit import AIAutoRepair, RequestConfig, ResponseData
    ...
    def test_dispatcher_dispatch_json_no_network(self):
        from core.http_toolkit import HOGDispatcher
    ...
    def test_session_manager_lifecycle(self, tmp_path):
        from core.http_toolkit import SESSION_FILE, SessionManager
    ...
    def test_safe_mode_env(self):
        from core.http_toolkit import SAFE_MODE
...
class TestGenerateTasksMd:
    ...
    def test_loads_tasks(self):
        from core.generate_tasks_md import load_tasks

        tasks = load_tasks()
        assert len(tasks) > 0

    def test_categorize(self):
        from core.generate_tasks_md import categorize_tasks
    ...
    def test_generate_markdown(self):
        from core.generate_tasks_md import categorize_tasks, generate_markdown
