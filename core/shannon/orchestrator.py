...
║                                                                              ║
║  Shannon provides the BRAIN. Leviathan provides the BODY.                    ║
...
class PromptContext:
    ...
    # Leviathan context
    leviathan_domains: List[str] = field(default_factory=list)
...
"""
    ...
    def _build_sections(self, ctx: PromptContext) -> Dict[str, str]:
        ...
        # Domains text
        domains_text = (
            ", ".join(ctx.leviathan_domains) if ctx.leviathan_domains else "All"
        )
        tools_text = (
        ...
        return {
            ...
            "shared_leviathan": self.SHARED_LEVIATHAN.format(
...
class SirenOrchestrator:
    ...
    def build_prompt(self, agent_name: str) -> str:
        ...
        if self.config:
            ...
            ctx.leviathan_domains = self.config.leviathan_domains
