...
████████████████████████████████████████████████████████████████████████████████████
██                                                                                ██
██  🔱  ABYSSAL AGENT REGISTRY — Shannon × Leviathan Neural Mesh  🔱             ██
██                                                                                ██
...
██    - O arsenal brutal do Leviathan (704+ tools)                                ██
...
██  Adaptado para o ecossistema Leviathan VS                                      ██
██                                                                                ██
...
class AgentDefinition:
    ...
    - Um conjunto de ferramentas Leviathan (MCP tools)
    ...
    # Leviathan-specific: quais dominios MCP este agente pode usar
    leviathan_domains: FrozenSet[str] = frozenset()

    # Ferramentas Leviathan preferidas para este agente
...
AGENTS: Dict[str, AgentDefinition] = {
    ...
    "xss-vuln": AgentDefinition(
        ...
        vuln_type="xss",
        phase="vulnerability-analysis",
        leviathan_domains=frozenset({"SURFACE_BREAKER", "PRESSURE_FORGE"}),
        preferred_tools=frozenset(
            {
                "xss_scan",
                "dom_xss",
    ...
    "xss-exploit": AgentDefinition(
        ...
        vuln_type="xss",
        phase="exploitation",
        leviathan_domains=frozenset({"PRESSURE_FORGE", "SURFACE_BREAKER"}),
        preferred_tools=frozenset(
            {
                "xss_exploit",
                "cookie_steal",
    ...
    "report": AgentDefinition(
        ...
        model_tier="small",
        phase="reporting",
        leviathan_domains=frozenset({"TENTACLE_PROTOCOL"}),
